                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-end">
                                    ...
                                    <p class="text-muted mb-0"><?= $db->from('seasons')->where('id', $season_id)
                                            ->first()['season_name'] ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="list-group list-group-flush">
                            <?php foreach ($faculties as $faculty) : ?>
                                <li class="list-group list-group-item mb-1 rounded">
                                    <a onclick="this.querySelector('i').classList.toggle('fa-chevron-down');
                                    this.querySelector('i').classList.toggle('fa-chevron-up');"
                                       data-bs-toggle="collapse" href="#collapse_course_<?= $faculty['id'] ?>"
                                       href="/proje/home/faculties/index.php?id=<?= $faculty['id'] ?>"
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <?php foreach ($db->from('courses')->where(
                                                ...
                                                <?php if ($faculty_course['department_id'] === $faculty['id']) : ?>
                                                    <li class="list-group list-group-item mb-1 rounded">
                                                        <a href="/proje/home/courses/index.php?code=<?= $faculty_course['code'] ?>"
