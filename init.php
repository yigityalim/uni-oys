            ...
            <div class="col-6">
                ...
                <div class="d-flex w-100 justify-content-center my-3">
                    ...
                    <a href="" class="btn btn-primary">
                        <img src="/proje/public/images/myy-profile.jpeg" alt="Özgür Özgün" class="rounded-circle" width="30">
                    ...
                    <div class="row">
                        <div class="col">
                            <label class="w-100">
                                ...
                                <input type="text" class="form-control" placeholder="Server" aria-label="Server" name="server" value="localhost">
                            </label>
                        </div>
                        <div class="col">
                            <label class="w-100">
                                <span class="fw-bold">Kullanıcı Adı:</span>
                                <input type="text" class="form-control" placeholder="Username" aria-label="Username" name="username" value="root">
                            </label>
                        </div>
                    </div>
                    <div class="row my-4">
                        ...
                        <div class="col">
                            <label class="w-100">
                                ...
                                <input type="text" class="form-control" placeholder="Database" aria-label="Database" name="database" value="yigit_yalim_ozgur_ozgun_db">
                            </label>
                        </div>
                    </div>
                ...
                <?php if ($succes) : ?>
                    <div class="alert alert-success justify-content-between d-flex align-items-center">
                        ...
                        <a href="/proje/auth/login" class="btn btn-success">Devam Et</a>
                    </div>
                <?php else : ?>
